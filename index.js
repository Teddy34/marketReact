...
/***/ function(module, exports, __webpack_require__) {
	...
	var ItemTab = (function (_React$Component) {
		_inherits(ItemTab, _React$Component);

		function ItemTab() {
			_classCallCheck(this, ItemTab);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(ItemTab).apply(this, arguments));
		}
